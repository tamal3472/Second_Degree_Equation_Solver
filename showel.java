 ...
 * @author TAMAL
 */
public class showel extends JFrame{
...
g2.drawString("1px is 80px for X & Y axes", 15, 18);
  ...
  //g2.draw(new QuadCuDDrve2D.Double(calkux1, 300+yc,500+xc,calkuy1,calkux2,300+yc));
 // g2.draw(new QuadCurve2D.Double(calkux1, 300+yc,500+xc,calkuy2,calkux2,300+yc));
    }
